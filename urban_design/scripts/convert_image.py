...
class compress_image:
    ...
    def compress_image(self, compress_ratio: float = 0.25, show_image: bool = False):
        ...
        image.save(self.image_path.replace(".png", "_compr_256.jpg"))
...
if __name__ == "__main__":
    compress_image = compress_image("E:/HKUST/202505_Agent_Urban_Design/MetaGPT/workspace_ce/initial/images/3D_View.png")
